    ...
    <ul class="ml-auto flex items-center">
        ...
        <li class="dropdown ml-3">
            ...
            <ul
                ...
                <li>
                    <a href="/"
                        class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-[#f84525] hover:bg-gray-50">Homepages</a>
                </li>
                <li>
                    <form action="/logout" method="POST" class="block"
                        ...
                        <button type="submit" role="menuitem" tabindex="-1" id="user-menu-item-2"
                            class="flex items-center text-[13px] py-1.5 px-4 text-gray-600 hover:text-[#f84525] hover:bg-gray-50">Log
                            out</button>
                    </form>
