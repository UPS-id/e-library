    ...
    <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12 lg:col-span-9 p-4">
            <div class="bg-white p-6 rounded-lg shadow">
                <h2 class="text-2xl font-semibold text-gray-800 mb-6">Author Form</h2>
                <form action="/dashboard/author/{{ $author->slug }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ $author->name ?? old('name') }}"
                            required
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" id="slug" value="{{ $author->slug ?? old('slug') }}"
                            required
